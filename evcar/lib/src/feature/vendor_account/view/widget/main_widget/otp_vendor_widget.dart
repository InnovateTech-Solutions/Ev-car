...
import 'package:evcar/src/feature/vendor_account/controller/otp_vendor_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';

class VendorOTPwidget extends GetView<VendorOTPcontroller> {
  const VendorOTPwidget({required this.number, super.key});

  final String number;
  @override
  Widget build(BuildContext context) {
    Get.put(VendorOTPcontroller(number));
